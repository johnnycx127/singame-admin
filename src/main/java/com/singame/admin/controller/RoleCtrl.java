...
public class RoleCtrl {
  ...
  public ResponseBody<RoleDTO> createRole(@RequestBody RoleDTO roleDTO) throws Exception {
  ...
  public ResponseBody<?> updateRole(@PathVariable("roleId") Long roleId, @RequestBody RoleDTO roleDTO) throws Exception {
  ...
  public ResponseBody<?> deleteRole(@PathVariable("roleId") Long roleId)
      throws Exception {
  ...
  public ResponseBody<RoleDTO> getRole(@PathVariable("roleId") Long roleId)
      throws Exception {
    logger.trace("roleId is {} \n", roleId.toString());
  ...
  @ApiResponses({ @ApiResponse(code = 200, message = "Success", response = ResponseBody.class),
      @ApiResponse(code = 400, message = "Bad Request", response = ResponseBody.class),
      @ApiResponse(code = 500, message = "Server Interal Error", response = ResponseBody.class) })
  @RequestMapping(value = "/permissions/dispatch", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseBody<?> dispatchRoles(@RequestBody DispatchRolePermissionDTO rolePermissionDTO)
      throws Exception {
    roleService.dispatchPermission(rolePermissionDTO.getRoleId(), rolePermissionDTO.getPermissionIdList());
    return new ResponseBody<>(ReplyBizStatus.OK, "success");
  }
}