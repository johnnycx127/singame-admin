...
public class PermissionCtrl {
  ...
  public ResponseBody<PermissionDTO> createPermission(@RequestBody PermissionDTO permissionDTO) throws Exception {
  ...
  public ResponseBody<?> updatePermission(@PathVariable("permissionId") Long permissionId, @RequestBody PermissionDTO permissionDTO)
      throws Exception {
  ...
  @RequestMapping(value = "/{permissionId}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseBody<?> deletePermission(@PathVariable("permissionId") Long permissionId) throws Exception {
