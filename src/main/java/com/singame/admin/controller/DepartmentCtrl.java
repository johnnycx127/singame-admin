...
public class DepartmentCtrl {
  ...
  public ResponseBody<DepartmentDTO> createDepartment(@RequestBody DepartmentDTO departmentDTO) throws Exception {
    ...
    Long id = departmentService.create(department);
  ...
  public ResponseBody<?> updateDepartment(@PathVariable("departmentId") Long departmentId,
  ...
  public ResponseBody<?> deleteDepartment(@PathVariable("departmentId") Long departmentId) throws Exception {
